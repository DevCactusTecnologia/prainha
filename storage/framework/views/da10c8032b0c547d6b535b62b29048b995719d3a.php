...
<div class="row">
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        <h5 class="font-size-15"><?php echo e($user->first_name); ?></h5>
                        <p class="text-muted mb-0 text-truncate"><?php echo e(__('Paciente')); ?></p>
                    </div>
                    <div class="col-sm-7">
                        <div class="pt-4">
                            <div class="row">
    ...
    <div class="col-xl-8">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"><?php echo e(__('Últimos Atendimentos')); ?></h4>
                            ...
                            <?php $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('appointments.result.print', $item->id)); ?>" class="btn btn-success text-white" target="_blank">
                                            <i class="mdi mdi-printer font-size-13 align-middle"></i>
                                        </a>
                                        <a href="<?php echo e(route('appointments.result.pdf', $item->id)); ?>" class="btn btn-danger text-white" target="_blank">
                                            PDF
                                        </a>
                                        <?php endif; ?>
                                    </td>
...
<?php /**PATH /home/hsdrjarques/lab.hospitaldrjarques.com.br/resources/views/layouts/patient-dashboard.blade.php ENDPATH**/ ?>