        ...
        <a href="/notification/<?php echo e($item->id); ?>" class="text-reset notification-item">
            <div class="media">
                ...
                <div class="media-body">
                    <h6 class="mt-0 mb-1"><?php echo e($item->user->first_name); ?></h6>
...
<?php endif; ?>
<?php /**PATH /home/hsdrjarques/lab.hospitaldrjarques.com.br/resources/views/layouts/ajax-notification.blade.php ENDPATH**/ ?>