<?php $__env->startSection('title'); ?><?php echo e(__('Atualizar Biomédico')); ?><?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__env->startComponent('components.breadcrumb'); ?>
        <?php $__env->slot('title'); ?> Atualizar biomédico  <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_2'); ?> <a href="<?php echo e(route('biomedicals.index')); ?>">Biomédicos</a> <?php $__env->endSlot(); ?>
        <?php $__env->slot('li_3'); ?> Atualizar biomédico <?php $__env->endSlot(); ?>
            ...
            <?php if($biomedical): ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('biomedicals.show', $biomedical->id)); ?>" class="btn btn-primary waves-effect mb-4">
                        <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Voltar para Perfil Biomédico')); ?>

                    </a>
                <?php endif; ?>
            <?php else: ?>
                <a href="<?php echo e(route('biomedicals.index')); ?>" class="btn btn-primary waves-effect mb-4">
                    <i class="bx bx-arrow-back font-size-16 align-middle mr-2"></i><?php echo e(__('Voltar à Lista Biomédica')); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hospitaldrjarque/laboratorio/resources/views/biomedicals/edit.blade.php ENDPATH**/ ?>