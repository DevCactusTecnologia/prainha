<?php $__env->startSection('title'); ?> <?php echo e(__('Lista de prescrição')); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Lista de prescrição <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Prescrição <?php $__env->endSlot(); ?>
                    ...
                    <div class="card-body">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <th><?php echo e(__('Nome do Médico')); ?></th>
                                    <?php endif; ?>
                                    <th><?php echo e(__('Data do Atendimento')); ?></th>
                                    <th><?php echo e(__('Horário  do Atendimento')); ?></th>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($prescription->appointment->timeSlot->from . ' às ' . $prescription->appointment->timeSlot->to); ?>
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Mostrando <?php echo e($prescriptions->firstItem()); ?> de <?php echo e($prescriptions->lastItem()); ?> de
                                <?php echo e($prescriptions->total()); ?> entradas
                            </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hsdrjarques/lab.hospitaldrjarques.com.br/resources/views/prescription/prescriptions.blade.php ENDPATH**/ ?>