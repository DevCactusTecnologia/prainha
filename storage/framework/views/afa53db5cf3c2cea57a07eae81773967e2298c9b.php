                    ...
                    <?php if($role == 'admin'): ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('biomedicals.index')); ?>">
                                <i class="bx bx-user-circle mr-2"></i> Biomédicos
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('routine.map.biomedical.index')); ?>">
                                    <i class='bx bx-notepad mr-2'></i>Mapa por biomédico
                                </a>
                                ...
                                <a class="dropdown-item" href="<?php echo e(route('routine.production.by.biomedical.index')); ?>">
                                    <i class='mdi mdi-microscope mr-2'></i>Produção do biomédico
                                </a>
...
<?php /**PATH /home/hsdrjarques/lab.hospitaldrjarques.com.br/resources/views/layouts/hor-menu.blade.php ENDPATH**/ ?>