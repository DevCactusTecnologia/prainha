<?php $__env->startSection('title'); ?> <?php echo e(__('Gateway de pagamento')); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('body'); ?>
    ...
    <?php $__env->startSection('content'); ?>
        ...
        <?php $__env->startComponent('components.breadcrumb'); ?>
            <?php $__env->slot('title'); ?> Gateway de pagamento <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_1'); ?> Dashboard <?php $__env->endSlot(); ?>
            <?php $__env->slot('li_2'); ?> Gateway de pagamento <?php $__env->endSlot(); ?>
        <?php echo $__env->renderComponent(); ?>
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <blockquote><?php echo e(__('Informações Razorpay')); ?></blockquote>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-12 col-sm-12 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <blockquote><?php echo e(__('Informações Stripe')); ?></blockquote>
                        <form action="<?php echo e(route('payment-key.store')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hospi580/lab.hospitaldrjarques.com.br/resources/views/admin/payment-key.blade.php ENDPATH**/ ?>