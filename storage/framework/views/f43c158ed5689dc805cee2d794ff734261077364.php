...
<div class="row">
    <div class="col-xl-4">
            ...
            <div class="card-body pt-0">
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        <h5 class="font-size-15"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h5>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <p class="text-muted mb-0">
                                        <?php echo e(date('d/m/Y H:i:s', strtotime($user->last_login))); ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <p class="text-muted"><?php echo e(__('Este mês')); ?></p>
                        ...
                        <p class="text-muted"><span class="<?php if($data['monthly_diff'] > 0): ?> text-success <?php else: ?> text-danger <?php endif; ?> mr-2"> <?php echo e($data['monthly_diff']); ?>% <i class="mdi <?php if($data['monthly_diff'] > 0): ?> mdi-arrow-up <?php else: ?> mdi-arrow-down <?php endif; ?>"></i> </span>
                            <?php echo e(__('Do mês anterior')); ?></p>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <p class="text-muted font-weight-medium"><?php echo e(__('Exibir itens por página')); ?></p>
                            <button
    ...
    <div class="col-xl-8">
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__('Receita')); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__("Ganhos de hoje")); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__('Atendimentos de hoje')); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__('Atendimentos de amanhã')); ?></p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                <p class="text-muted font-weight-medium"><?php echo e(__('Próximos Atendimentos')); ?></p>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"><?php echo e(__('Atendimentos Mensais')); ?></h4>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"><?php echo e(__("Agendamentos de hoje")); ?></h4>
...
<!-- end row -->
<?php /**PATH /home/hsdrjarques/lab.hospitaldrjarques.com.br/resources/views/layouts/doctor-dashboard.blade.php ENDPATH**/ ?>