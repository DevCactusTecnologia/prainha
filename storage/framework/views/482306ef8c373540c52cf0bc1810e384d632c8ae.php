                ...
                <ul class="navbar-nav">
                    ...
                    <?php if($role == 'admin'): ?>
                        <li class="nav-item dropdown">
                                ...
                                >
                                    <i class="bx bx-user-circle mr-2"></i>Profissionais <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="topnav-layout">
                                    <a class="dropdown-item" href="<?php echo e(route('doctors.index')); ?>">
                                        Médicos
                                    </a>
                                    <a class="dropdown-item" href="<?php echo e(route('receptionists.index')); ?>">
                                        Recepcionistas
                                    </a>
                                    <a class="dropdown-item" href="<?php echo e(route('biomedicals.index')); ?>">
                                        Analistas
                                    </a>
                                </div>
                            </li>
...
<?php /**PATH /home3/hospi580/lab.hospitaldrjarques.com.br/resources/views/layouts/hor-menu.blade.php ENDPATH**/ ?>