                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 form-group">
                            ...
                            <button type="submit" id="createAttendance" 
                                class="form-control btn btn-primary font-weight-medium rounded-lg"
                            >
                                Criar Atendimento
                            </button>
                        </div>
...
<?php echo $__env->make('layouts.master-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/hospi580/lab.hospitaldrjarques.com.br/resources/views/appointments/create.blade.php ENDPATH**/ ?>