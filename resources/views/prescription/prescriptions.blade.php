                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($prescriptions as $prescription)
                                    <tr>
                                        ...
                                        <td>{{ $prescription->appointment->timeSlot->from . ' às ' . $prescription->appointment->timeSlot->to }}
                                        </td>
                                        <td>
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <div class="d-flex justify-content-start">
                                Mostrando {{ $prescriptions->firstItem() }} de {{ $prescriptions->lastItem() }} de
                                {{ $prescriptions->total() }} entradas
                            </div>
