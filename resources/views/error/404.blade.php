...
@section('title') {{ __("Página não encontrada") }} @endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        ...
                        <h4 class="text-uppercase" style="font-weight: 600;">{{ __("Página não encontrada!") }}</h4>
                        <h6 class="text-secondary">{{ __("Desculpe, a página que você está procurando não existe!") }}</h6>
